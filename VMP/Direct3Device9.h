...
-- File: Direct3Device9.h
-- Project: Client
-- Author(s): m0niSx
-- Description: Direct3Device9 interface hook header file
=============================================================*/

#ifndef DIRECT3DEVICE9_H
#define DIRECT3DEVICE9_H

#include <d3d9.h>
#include <d3dx9.h>

class CIDirect3DDevice9 : public IDirect3DDevice9
{
	public:
		CIDirect3DDevice9(IDirect3D9 *pD3D, IDirect3DDevice9 *pOriginal);
		virtual ~CIDirect3DDevice9(void);
		//////////////////////////////////////////////////////////////
		...
		HRESULT __stdcall BeginScene(void); // A4
