...
-- Project: Client
-- Author(s): IV:MP Team
-- Description: Xlive hooks source file
=============================================================*/
...
void InstallXLiveHook()
{
	for(int i = 0; i < XLIVEHOOK_SIZE; i++)
	{
		DetourFunction(DetourFindFunction("xlive.dll", (char *)MAKELONG(xliveHookFunctions[i].uiOrdinal, 0)), (PBYTE)xliveHookFunctions[i].dwFunction);
	}
}
